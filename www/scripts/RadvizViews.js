...
RadvizViews.prototype.addDimensionsGroup = function (dimensionGroup) {
    ...
    this.groups[this.numberOfGroups] = dimensionGroup;
    var _this = this;
    ...
    dimensionGroup.dimensions.forEach(function (d, i) {
        ...
        dimG.append("text")
            ...
            .attr("transform", "translate(" + dimensionGroup.radius + ",0) rotate(" + (180 - d.pos) + ") scale(-1,1)");
...
RadvizViews.prototype.removeDimension = function (idx) {
